...
type
  ...
  pseudoop = (bad, addint, addptr, addr, addreal, addset, addstr, aindx, andint,
              ...
              copyaccess, copystack, fileparam,  condvaluef, condvaluet, createfalse,
              createtemp, createtrue, cvtdr, cvtrd, dataadd, dataaddr, dataend,
              datafaddr, datafield, datafill, dataint, datareal, datastart, datastore,
              datastruct, datasub, decint, defforindex, defforlitindex, definelazy,
              ...
              pshstruct, ptrchk, ptrregparam, ptrregtarget, ptrtemp, rangechk,
              rdbin, rdchar, rdint, rdreal, rdst, rdxstr, realregparam,
              realregtarget, realtemp, regparam, regtarget, regtemp, restorelabel,
