...
{ Support library routines
  ...
  orinst, orn, andinst, bic, eor, eon, neg, last_a,
  ...
  nodekinds = (instnode, oprndnode, labelnode, labeldeltanode, errornode, stmtnode,
               datanode, labelrefnode, proclabelnode, textnode, rodatanode, commnode,
               commentnode);
...
var
  ...
  filereg: regindex; {the callee-saved register holding binfile for
                         later access}
