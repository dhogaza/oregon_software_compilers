...
const
  ...
  useglobalcontext = false; {don't let travrs use the global context for things
                             like "doint" because we need to generate code
...
{ Machine dependent parameters
  ...
  maxusword = $FFFFFFFF; {Max value for a 16-bit value}
  ...
  maxgenregistermask = 31;
  maxptrregistermask = 0;
  maxrealregistermask = 31;
...
{ Analys parameters }
  ...
  setintbytes = 4; {maximum set size (bytes) to pass as int rather in const data}
